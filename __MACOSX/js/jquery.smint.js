 ...
 $(document).ready(function(){
          $("#menu-toggle").click(function(e) {
           ...
           $(window).scroll(function() {
            if ($(this).scrollTop() > 301) { //use `this`, not `document`
                $('.navbar').removeClass('navbar-scroll-manupulations');
                $('.menu-item').removeClass('menu-item-manupulations');
                $('.menu-item').removeClass('menu-item-manupulations');
            ...
            if($(this).scrollTop() < 301){
                $('.navbar').addClass('navbar-scroll-manupulations');
                $('.menu-item').addClass('menu-item-manupulations');
                $('.menu-item').addClass('menu-item-manupulations');
                 $('#logo').attr('src', 'pictures/carousel-logo.png');
            }
